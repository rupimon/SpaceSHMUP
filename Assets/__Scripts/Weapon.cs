...
// in the Inspector pane. It does not work for everything, but it 
...
public class Weapon : MonoBehaviour {
	...
	void Awake () {
		collar = transform.Find ("Collar").gameObject; // Moved out of Start to resolve racing
	}

	// Use this for initialization
	void Start () {
		// Here the collar assignment was there before that is moved to Awake() to resolve racing
	...
	public void Fire () {
		...
		// If it hasn't ben enough time between shots, return
