...
public class PowerUp : MonoBehaviour {
	// This ia an unusual but handy use of Vector2s. x holds a min value
	...
	void Awake() {
		...
		// Random.onUnitSphere gives a vector point that is somewhere
	...
	public void SetType(WeaponType wt) {
		...
		// letter.color = def.color; // We could colorize the letter too Commented
