...
public class Main : MonoBehaviour {
	...
	public void Awake () {
		...
		// this.camera changed to this.GetComponent<Camera>() for Unity5

		// 0.5 enemies /second = enemySpawnRate of 2
		enemySpawnRate = 1f / enemySpawnPerSecond;
		// Invoke call SpawnEnemy() once after a 2 seconds delay
	...
	static public WeaponDefinition GetWeaponDefinition(WeaponType wt) {
		...
		// Attempting to retrieve a key that did not exist, would show an error
	...
	public void ShipDestroyed(Enemy e) {
		...
		if (Random.value <= e.powerUpDropChance) {
			...
			// 50% of the time. For testing, it is now set to 1f
